...
import { e as renderElement, g as generateCspDigest, f as spreadAttributes, u as unescapeHTML, b as renderTemplate, h as removeBase, i as isRemotePath, j as unflatten, A as AstroError, U as UnknownContentCollectionError, o as object, k as date, l as array, R as RenderUndefinedEntryError, n as escape, p as string, q as prependForwardSlash, t as createHeadAndContent, r as renderComponent } from "./worker-entry_C595MgLD.mjs";
import { c as createComponent } from "./Footer_DY66i9Gu.mjs";
import { V as VALID_INPUT_FORMATS } from "./consts_D6Ty4GCC.mjs";
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import("./_astro_data-layer-content_1QCfQTBn.mjs");
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import("./_virtual_astro_get-image_CAQbzAwI.mjs");
