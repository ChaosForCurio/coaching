...
import { e as renderElement, g as generateCspDigest, f as spreadAttributes, u as unescapeHTML, b as renderTemplate, h as removeBase, i as isRemotePath, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, p as prependForwardSlash, j as createHeadAndContent, r as renderComponent } from './prerender_DwZ5v2Mm.mjs';
import { c as createComponent } from './Footer_Cx4TwuOa.mjs';
import 'clsx';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DE_aqjVg.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_B0yjgwwE.mjs');
