...
function generateCourseSchema(courseTitle, courseDescription, canonicalUrl, imageUrl) {
  return {
    "@context": "https://schema.org",
    "@graph": [
      {
...
export {
  generateCourseSchema as a,
  generateFAQSchema as b,
  generateLocalBusinessSchema as c,
  generateBlogPostSchema as g
};
