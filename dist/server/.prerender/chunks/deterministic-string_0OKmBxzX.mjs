...
import { y as removeQueryString, A as AstroError, N as NoImageMetadata, z as isRemoteAllowed, B as FailedToFetchRemoteImageDimensions, C as RemoteImageNotAllowed, D as joinPaths, E as ExpectedImage, i as isRemotePath, L as LocalImageUsedWrongly, M as MissingImageDimension, G as UnsupportedImageFormat, H as IncompatibleDescriptorOptions, J as UnsupportedImageConversion, K as ExpectedImageOptions, O as ExpectedNotESMImage, P as InvalidImageService } from "./worker-entry_C595MgLD.mjs";
import { D as DEFAULT_OUTPUT_FORMAT, a as DEFAULT_HASH_PROPS, b as VALID_SUPPORTED_FORMATS } from "./consts_D6Ty4GCC.mjs";
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      "./image-service-workerd_CgxEkYmZ.mjs"
    ).catch((e) => {
