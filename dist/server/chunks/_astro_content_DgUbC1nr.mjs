...
import { aA as generateCspDigest, b6 as unescapeHTML, K as renderTemplate, bA as removeBase, b4 as isRemotePath, A as AstroError, bB as UnknownContentCollectionError, bn as object, bs as date, bq as array, bo as string } from "./sequence_DmJMvBqm.mjs";
import { s as spreadAttributes, u as unflatten } from "./worker-entry_xIepYUAn.mjs";
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import("./_astro_data-layer-content_C6xCm-MQ.mjs");
...
function createGetEntry({ liveCollections: liveCollections2 }) {
