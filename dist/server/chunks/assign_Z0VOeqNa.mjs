...
import 'piccolore';
import { I as renderTemplate, bk as defineScriptVars, _ as addAttribute, F as Fragment, v as maybeRenderHead } from './sequence_CMdjYNBY.mjs';
import { r as renderComponent } from './entrypoint_CqE5cXTs.mjs';
import { $ as $$DashboardLayout } from './DashboardLayout_DZsQbiib.mjs';
import { d as db, c as courses, u as users, e as enrollments } from './schema_UQndYuIj.mjs';
