...
import 'piccolore';
import { v as maybeRenderHead, _ as addAttribute, I as renderTemplate, b5 as renderHead } from './sequence_DI9gLznW.mjs';
...
import 'clsx';
import { $ as $$Image } from './_astro_assets_CCV9Pz_r.mjs';
import { $ as $$Footer } from './Footer_Bxtrk-LB.mjs';

const $$Methodology = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section id="methodology" class="py-20 md:py-40 bg-white text-black relative overflow-hidden"> <div class="absolute top-0 right-0 p-4 md:p-20 opacity-[0.03] pointer-events-none"> <h2 class="text-[8rem] sm:text-[12rem] md:text-[16rem] lg:text-[20rem] leading-none font-black italic">
BCI
...
</p> </div> </div> </div> <div class="space-y-16"> ${[
    {
      num: "01",
...
const $$AboutUs = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head>${renderComponent($$result, "SEOHead", $$SEOHead, { "title": "About Us | Bhavya Computer Classes — Computer Training in Kota", "description": "Learn about Bhavya Computer Classes — Kota's trusted computer training center since 2010. Meet our expert faculty, discover our teaching methodology, and read real student reviews.", "canonical": "https://www.bhavyacomputerclasses.com/about-us", "schema": breadcrumbSchema })}${renderHead()}</head> <body class="bg-[#0a0a0a] text-white overflow-x-hidden selection:bg-white/20"> ${renderComponent($$result, "Cursor", $$Cursor, {})} ${renderComponent($$result, "Navbar", $$Navbar, {})} <main class="w-full pt-24"> ${renderComponent($$result, "Methodology", $$Methodology, {})} ${renderComponent($$result, "FacultyTeam", $$FacultyTeam, {})} <!-- Unique Insights Section --> <section class="max-w-7xl mx-auto px-4 md:px-14 py-24 border-t border-white/10 relative overflow-hidden"> <div class="absolute inset-0 bg-gradient-to-b from-[#10b981]/5 to-transparent pointer-events-none"></div> <div class="relative z-10 flex flex-col md:flex-row gap-12 items-center"> <div class="w-full md:w-1/2"> <span class="text-[#10b981] text-xs font-bold uppercase tracking-widest mb-4 block">First-Party Data</span> <h2 class="text-4xl md:text-5xl font-bold mb-6">
...
</p> <ul class="space-y-4"> <li class="flex items-start gap-4"> <div class="w-8 h-8 rounded-full bg-[#10b981]/20 flex items-center justify-center flex-shrink-0 mt-1"> <svg class="w-4 h-4 text-[#10b981]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> </div> <p class="text-white/80">
Demand for <strong>Tally with GST professionals</strong> in Kota's
                  coaching and retail sectors has increased by <span class="text-[#10b981] font-bold">40%</span> over the past year.
</p> </li> <li class="flex items-start gap-4"> <div class="w-8 h-8 rounded-full bg-[#10b981]/20 flex items-center justify-center flex-shrink-0 mt-1"> <svg class="w-4 h-4 text-[#10b981]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> </div> <p class="text-white/80">
...
Over <span class="text-[#10b981] font-bold">65%</span> of government
...
</h3> <div class="space-y-6"> <div> <div class="flex justify-between text-sm mb-2"> <span class="text-white/60">Accounting & GST</span><span class="text-[#10b981]">+40%</span> </div> <div class="w-full h-2 bg-white/10 rounded-full overflow-hidden"> <div class="h-full bg-[#10b981] w-[85%]"></div> </div> </div> <div> <div class="flex justify-between text-sm mb-2"> <span class="text-white/60">Data Entry & Advanced Excel</span><span class="text-[#22d3ee]">+25%</span> </div> <div class="w-full h-2 bg-white/10 rounded-full overflow-hidden"> <div class="h-full bg-[#22d3ee] w-[65%]"></div> </div> </div> <div> <div class="flex justify-between text-sm mb-2"> <span class="text-white/60">Govt IT Assistants (RSCIT required)</span><span class="text-[#6366f1]">+35%</span> </div> <div class="w-full h-2 bg-white/10 rounded-full overflow-hidden"> <div class="h-full bg-[#6366f1] w-[75%]"></div> </div> </div> <div> <div class="flex justify-between text-sm mb-2"> <span class="text-white/60">Web & App Development</span><span class="text-[#ec4899]">+20%</span> </div> <div class="w-full h-2 bg-white/10 rounded-full overflow-hidden"> <div class="h-full bg-[#ec4899] w-[45%]"></div> </div> </div> </div> <p class="text-xs text-white/40 mt-6 text-center italic">
* Data gathered from Bhavya Computer Classes alumni network and
              partnered local businesses in Kota.
</p> </div> </div> </section> ${renderComponent($$result, "Reviews", $$Reviews, {})} </main> ${renderComponent($$result, "Footer", $$Footer, {})} ${renderScript($$result, "D:/Coding Projects/coaching/src/pages/about-us.astro?astro&type=script&index=0&lang.ts")} </body> </html>`;
