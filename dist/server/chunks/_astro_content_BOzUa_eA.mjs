...
export { z };
import { o as renderElement, p as generateCspDigest, s as spreadAttributes, u as unescapeHTML, r as renderTemplate, A as AstroError, q as UnknownContentCollectionError, t as RenderUndefinedEntryError, v as createHeadAndContent, c as renderComponent } from './server_DWfAt-kb.mjs';
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_D0ZJDiUv.mjs');
