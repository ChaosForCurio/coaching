...
import { b7 as removeQueryString, A as AstroError, b8 as NoImageMetadata, b9 as FailedToFetchRemoteImageDimensions, ba as RemoteImageNotAllowed, ax as joinPaths, bb as ExpectedImage, b4 as isRemotePath, bc as LocalImageUsedWrongly, bd as MissingImageDimension, be as UnsupportedImageFormat, bf as IncompatibleDescriptorOptions, bg as UnsupportedImageConversion, bh as ExpectedImageOptions, bi as ExpectedNotESMImage, bj as InvalidImageService, bk as ImageMissingAlt, w as maybeRenderHead, a0 as addAttribute, K as renderTemplate, bl as FontFamilyNotFound, b6 as unescapeHTML, bm as MissingGetFontFileRequestUrl } from "./sequence_DmJMvBqm.mjs";
import { i as isRemoteAllowed, s as spreadAttributes } from "./worker-entry_xIepYUAn.mjs";
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      "./image-service-workerd_DFZ-csZZ.mjs"
    ).catch((e) => {
