...
import { r as requireReact } from "./index_QEzo1o-5.mjs";
...
function requireServer_edge() {
  if (hasRequiredServer_edge) return server_edge$2;
  ...
  server_edge$2.version = b.version;
  server_edge$2.renderToReadableStream = b.renderToReadableStream;
  server_edge$2.renderToString = l.renderToString;
  server_edge$2.renderToStaticMarkup = l.renderToStaticMarkup;
  server_edge$2.resume = b.resume;
  return server_edge$2;
}
