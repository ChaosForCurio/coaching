...
export { z };
import { ay as generateCspDigest, bk as unescapeHTML, I as renderTemplate, bo as removeBase, b2 as isRemotePath, A as AstroError, bp as UnknownContentCollectionError } from './sequence_DI9gLznW.mjs';
import { s as spreadAttributes } from './server_CAbLtFaR.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DiPx-pbO.mjs');
