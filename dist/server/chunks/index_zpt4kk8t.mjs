...
import 'piccolore';
import { bk as renderHead, _ as addAttribute, bh as unescapeHTML, I as renderTemplate } from './sequence_Dp-Tbm17.mjs';
import { r as renderComponent } from './server_DcQuEEIJ.mjs';
import { getCollection } from './_astro_content_BFL4gX66.mjs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const blogSchema = {
    ...
    "@graph": [
      {
        "@type": "Blog",
        "@id": "https://coaching-ts8v.onrender.com/blog",
        "name": "Bhavya Career Institute Blog",
        "url": "https://coaching-ts8v.onrender.com/blog",
        ...
        "publisher": {
          ...
          "url": "https://coaching-ts8v.onrender.com"
        },
        "blogPost": sortedPosts.map((post) => ({
          "@type": "BlogPosting",
          "headline": post.data.title,
          "datePublished": post.data.date.toISOString().split("T")[0],
          "author": { "@type": "Organization", "name": post.data.author || "Bhavya Career Institute" }
        }))
      },
      {
        "@type": "BreadcrumbList",
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 2, "name": "Blog", "item": "https://coaching-ts8v.onrender.com/blog" }
        ]
      }
    ]
  };
