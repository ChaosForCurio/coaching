...
import 'piccolore';
import { I as renderTemplate, v as maybeRenderHead, _ as addAttribute } from './sequence_DI9gLznW.mjs';
import { r as renderComponent } from './server_CAbLtFaR.mjs';
import { r as renderScript } from './script_BITFEDOq.mjs';
import { $ as $$DashboardLayout } from './DashboardLayout_ByM4GOqv.mjs';
import { d as db, e as enrollments, c as courses, b as attendance } from './schema_B5qW88Nb.mjs';
...
const $$Courses = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (role === "STUDENT") {
    ...
    studentCourses = allCourses.filter(
      (c) => myEnrollments.some((e) => e.course_id === c.id)
    );
