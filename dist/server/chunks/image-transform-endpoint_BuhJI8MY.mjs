...
import { f as fetchWithRedirects, i as imageConfig } from "./_astro_assets_zNbrNOa7.mjs";
import { b4 as isRemotePath } from "./sequence_CMysm0T6.mjs";
import { i as isRemoteAllowed } from "./worker-entry_BXKqGpOE.mjs";
const qualityTable = {
  low: 25,
  mid: 50,
  high: 80,
