...
const connectionString = "postgresql://neondb_owner:npg_2hqP5xpdHtEZ@ep-wispy-truth-ap7kmm96.c-7.us-east-1.aws.neon.tech/neondb?sslmode=require";
const readConnectionString = "postgresql://neondb_owner:npg_2hqP5xpdHtEZ@ep-wispy-truth-ap7kmm96.c-7.us-east-1.aws.neon.tech/neondb?sslmode=require";
...
const passkeys = pgTable("passkeys", {
  id: serial("id").primaryKey(),
  user_id: integer("user_id").references(() => users.id).notNull(),
...
export { announcements as a, attendance as b, courses as c, db as d, enrollments as e, auditLogs as f, passkeys as g, notifications as n, passwordResetTokens as p, readDb as r, sessions as s, users as u };
