import { d as db, u as users, s as sessions } from './schema_CuVt3FVI.mjs';
import { eq, desc, and, gt } from 'drizzle-orm';
import crypto from 'node:crypto';
import { v as validateStackSession, g as getOrCreateLocalUser } from './stack_DeFeyIBb.mjs';
...
async function getSessionUserId(cookies) {
  ...
  if (stackToken) {
    const stackUser = await validateStackSession();
    if (stackUser) {
      try {
