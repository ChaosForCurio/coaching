...
import { aA as generateCspDigest, b6 as unescapeHTML, K as renderTemplate, bp as removeBase, b4 as isRemotePath, A as AstroError, bq as UnknownContentCollectionError, br as object, bs as date, bt as array, bu as string } from "./sequence_CMysm0T6.mjs";
import { s as spreadAttributes, u as unflatten } from "./worker-entry_BXKqGpOE.mjs";
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import("./_astro_data-layer-content_Ci07txKs.mjs");
