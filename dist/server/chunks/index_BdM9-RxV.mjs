...
import { b5 as renderHead, a0 as addAttribute, K as renderTemplate } from "./sequence_DmJMvBqm.mjs";
import { r as renderComponent } from "./worker-entry_xIepYUAn.mjs";
import { getCollection } from "./_astro_content_DgUbC1nr.mjs";
import { $ as $$Navbar, a as $$Footer } from "./global_CxnhDMbw.mjs";
...
Read Article
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="group-hover:translate-x-1 transition-transform" aria-hidden="true"> <path d="M5 12h14"></path> <path d="m12 5 7 7-7 7"></path> </svg> </div> </div> </article> </a>`;
