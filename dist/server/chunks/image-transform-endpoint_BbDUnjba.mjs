...
import { f as fetchWithRedirects, i as imageConfig } from "./_astro_assets_CuHacDRA.mjs";
import { b4 as isRemotePath } from "./sequence_DmJMvBqm.mjs";
import { i as isRemoteAllowed } from "./worker-entry_xIepYUAn.mjs";
const qualityTable = {
  low: 25,
  mid: 50,
  high: 80,
