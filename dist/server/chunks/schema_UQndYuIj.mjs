...
dotenv.config();
const connectionString = process.env.DATABASE_URL || "postgresql://postgres.qttzzkrwijtxnmeukmlx:Yq603SikoeJ3hTPV@aws-1-ap-southeast-1.pooler.supabase.com:5432/postgres";
