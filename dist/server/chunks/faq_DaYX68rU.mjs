    ...
    "@graph": [
      {
        ...
        mainEntity: [
          {
            "@type": "Question",
            name: "What is the admission process at Bhavya Computer Classes?",
            acceptedAnswer: {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            name: "What courses does Bhavya Computer Classes offer?",
            acceptedAnswer: {
              "@type": "Answer",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 2,
            name: "FAQ",
            item: "https://www.bhavyacomputerclasses.com/faq"
          }
        ]
      }
    ]
