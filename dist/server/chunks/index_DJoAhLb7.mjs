    ...
    "@graph": [
      {
        ...
        "blogPost": sortedPosts.map((post) => ({
          ...
          "author": { "@type": "Organization", "name": post.data.author || "Bhavya Computer Classes" }
        }))
      },
      {
        "@type": "BreadcrumbList",
