...
import 'piccolore';
import { v as maybeRenderHead, _ as addAttribute, I as renderTemplate, b3 as unescapeHTML, b2 as renderHead } from './sequence_CMdjYNBY.mjs';
import { r as renderComponent } from './entrypoint_CqE5cXTs.mjs';
import { r as renderScript } from './script_C3Eb1sAZ.mjs';
/* empty css                 */
import { $ as $$SEOHead } from './SEOHead_CG-8pz80.mjs';
import { $ as $$Cursor } from './Cursor_rv8hCYUo.mjs';
import { $ as $$Navbar } from './Navbar_DsXkJg_q.mjs';
import { $ as $$Image } from './_astro_assets_BCums5Gk.mjs';
import 'clsx';
import { $ as $$Footer } from './Footer_C7rAs54S.mjs';
import { $ as $$WhatsAppFloat } from './WhatsAppFloat_Bz4-lZ52.mjs';

const $$Methodology = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section id="methodology" class="py-20 md:py-40 bg-white text-black relative overflow-hidden"> <div class="absolute top-0 right-0 p-4 md:p-20 opacity-[0.03] pointer-events-none"> <h2 class="text-[25vw] sm:text-[12rem] md:text-[16rem] lg:text-[20rem] leading-none font-black italic">
BCI
</h2> <!-- BCI is the internal abbreviation for Bhavya Computer Classes, used as a decorative watermark --> </div> <div class="container mx-auto px-4 md:px-8 relative z-10"> <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center"> <div> <div data-reveal="up" class="opacity-0 translate-y-8 md:translate-y-12 transition-all duration-1000 ease-out"> <h2 class="text-4xl sm:text-5xl md:text-6xl lg:text-8xl leading-[0.9] mb-8 md:mb-12 break-words tracking-tight">
The<br>BHAVYA<br>Vision
</h2> <p class="text-xl text-black/60 font-light leading-relaxed mb-8">
Bhavya Computer Classes is dedicated to empowering students with
            practical, job-ready skills. Our library facility and expert faculty
            ensure every student succeeds.
</p> <div class="mt-6 border-l-4 border-black/80 pl-5"> <p class="text-sm text-black/50 uppercase tracking-widest">
Library Available
</p> <p class="text-black/70 mt-1 text-sm">
Free access to our resource library for all enrolled students.
</p> </div> <!-- Classroom Photo — real institute photo for trust/credibility --> <div class="mt-10 group relative rounded-2xl overflow-hidden shadow-2xl"> ${renderComponent($$result, "Image", $$Image, { "src": "/images/classroom.png", "alt": "Inside Bhavya Computer Classes — computer lab with students", "width": "700", "height": "468", "loading": "lazy", "decoding": "async", "class": "w-full h-auto object-cover transition-transform duration-700 ease-out group-hover:scale-105" })} <!-- Gradient overlay at the bottom for the caption --> <div class="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-black/70 to-transparent"></div> <!-- Caption badge --> <div class="absolute bottom-4 left-4 flex items-center gap-2"> <span class="inline-flex items-center gap-1.5 bg-white/10 backdrop-blur-sm border border-white/20 text-white text-xs font-semibold px-3 py-1.5 rounded-full"> <svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"> <circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline> </svg>
Est. 2010 · Kota, Rajasthan
</span> </div> </div> </div> </div> <div class="space-y-16"> ${[
    {
      num: "01",
...
const libraryClassroomImg = new Proxy({"src":"/_astro/library-classroom.CBDjFy1W.jpg","width":1024,"height":768,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/Coding Projects/coaching/public/images/library-classroom.jpg";
							}
...
const $$FacultyTeam = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section id="faculty" class="py-32 bg-[#0a0a0a] border-t border-white/5"> <div class="container mx-auto px-8"> <!-- Section Header --> <div class="flex flex-col md:flex-row justify-between items-start mb-20"> <div> <span data-reveal="up" class="text-[10px] uppercase tracking-[0.2em] sm:tracking-[0.6em] text-white/30 opacity-0 translate-y-4 transition-all duration-800 ease-out inline-block break-words">
Expert Mentors
</span> <h2 data-reveal="up" style="transition-delay: 100ms;" class="text-4xl md:text-7xl lg:text-8xl italic mt-3 opacity-0 translate-y-8 transition-all duration-800 ease-out break-words">
Our Faculty
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "About Us",
        item: "https://www.bhavyacomputerclasses.com/about-us"
      }
    ]
  };
  return renderTemplate`<html lang="en"> <head>${renderComponent($$result, "SEOHead", $$SEOHead, { "title": "About Us | Bhavya Computer Classes — Computer Training in Kota", "description": "Learn about Bhavya Computer Classes — Kota's trusted computer training center since 2010. Meet our expert faculty, discover our teaching methodology, and read real student reviews.", "canonical": "https://www.bhavyacomputerclasses.com/about-us", "schema": breadcrumbSchema })}${renderHead()}</head> <body class="bg-[#0a0a0a] text-white overflow-x-hidden selection:bg-white/20"> ${renderComponent($$result, "Cursor", $$Cursor, {})} ${renderComponent($$result, "Navbar", $$Navbar, {})} <main class="w-full pt-24"> ${renderComponent($$result, "Methodology", $$Methodology, {})} ${renderComponent($$result, "FacultyTeam", $$FacultyTeam, {})} <!-- Unique Insights Section --> <section class="max-w-7xl mx-auto px-4 md:px-14 py-24 border-t border-white/10 relative overflow-hidden"> <div class="absolute inset-0 bg-gradient-to-b from-white/5 to-transparent pointer-events-none"></div> <div class="relative z-10 flex flex-col md:flex-row gap-12 items-center"> <div class="w-full md:w-1/2">
class="text-white text-xs font-bold uppercase tracking-widest mb-4 block"
              >First-Party Data
<h2 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 break-words">
Kota Tech Job Market Insights
</h2> <p class="text-white/70 text-lg leading-relaxed mb-6">
Our continuous involvement in the local tech ecosystem allows us
              to observe hiring trends closely. According to our exclusive 2025
              placement data from Bhavya Computer Classes:
</p> <ul class="space-y-4"> <li class="flex items-start gap-4"> <div class="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-1"> <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> </div> <p class="text-white/80">
Demand for <strong>Tally with GST professionals</strong> in Kota's
                  coaching and retail sectors has increased by <span class="text-white font-bold">40%</span> over the past year.
</p> </li> <li class="flex items-start gap-4"> <div class="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-1"> <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> </div> <p class="text-white/80">
Local businesses are actively prioritizing candidates with
                  dual competency in <strong>Advanced Excel</strong> and <strong>Basic Python automation</strong>.
</p> </li> <li class="flex items-start gap-4"> <div class="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-1"> <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> </div> <p class="text-white/80">
Over <span class="text-white font-bold">65%</span> of government
                  and semi-government contractual openings in the region now mandate
                  the <strong>RSCIT certification</strong> as a baseline requirement.
</p> </li> </ul> </div> <div class="w-full md:w-1/2 bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm"> <h3 class="text-xl font-bold mb-6 text-center">
Hiring Growth in Kota (2024-2025)
</h3> <div class="space-y-6"> <div> <div class="flex justify-between text-sm mb-2"> <span class="text-white/60">Accounting & GST</span><span class="text-white">+40%</span> </div> <div class="w-full h-2 bg-white/10 rounded-full overflow-hidden"> <div class="h-full bg-white w-[85%]"></div> </div> </div> <div> <div class="flex justify-between text-sm mb-2"> <span class="text-white/60">Data Entry & Advanced Excel</span><span class="text-white">+25%</span> </div> <div class="w-full h-2 bg-white/10 rounded-full overflow-hidden"> <div class="h-full bg-white w-[65%]"></div> </div> </div> <div> <div class="flex justify-between text-sm mb-2"> <span class="text-white/60">Govt IT Assistants (RSCIT required)</span><span class="text-white">+35%</span> </div> <div class="w-full h-2 bg-white/10 rounded-full overflow-hidden"> <div class="h-full bg-white w-[75%]"></div> </div> </div> <div> <div class="flex justify-between text-sm mb-2"> <span class="text-white/60">Web & App Development</span><span class="text-white">+20%</span> </div> <div class="w-full h-2 bg-white/10 rounded-full overflow-hidden"> <div class="h-full bg-white w-[45%]"></div> </div> </div> </div> <p class="text-xs text-white/40 mt-6 text-center italic">
* Data gathered from Bhavya Computer Classes alumni network and
              partnered local businesses in Kota.
</p> </div> </div> </section> ${renderComponent($$result, "Reviews", $$Reviews, {})} </main> ${renderComponent($$result, "Footer", $$Footer, {})} ${renderComponent($$result, "WhatsAppFloat", $$WhatsAppFloat, {})} ${renderScript($$result, "D:/Coding Projects/coaching/src/pages/about-us.astro?astro&type=script&index=0&lang.ts")} </body> </html>`;
