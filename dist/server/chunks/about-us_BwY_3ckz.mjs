...
import { w as maybeRenderHead, a0 as addAttribute, K as renderTemplate, b6 as unescapeHTML, b5 as renderHead } from "./sequence_DmJMvBqm.mjs";
import { r as renderComponent } from "./worker-entry_xIepYUAn.mjs";
import { r as renderScript, $ as $$Navbar, a as $$Footer } from "./global_CxnhDMbw.mjs";
import { $ as $$SEOHead, a as $$WhatsAppFloat } from "./WhatsAppFloat_t3aFH5A3.mjs";
import { $ as $$Image } from "./_astro_assets_CuHacDRA.mjs";
...
const $$AboutUs = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head>${renderComponent($$result, "SEOHead", $$SEOHead, { "title": "About Us | Bhavya Computer Classes — Computer Training in Kota", "description": "Learn about Bhavya Computer Classes — Kota's trusted computer training center since 2010. Meet our expert faculty, discover our teaching methodology, and read real student reviews.", "canonical": "https://www.bhavyacomputerclasses.com/about-us", "schema": breadcrumbSchema })}${renderHead()}</head> <body class="bg-[#0a0a0a] text-white overflow-x-hidden selection:bg-white/20"> ${renderComponent($$result, "Navbar", $$Navbar, {})} <main class="w-full pt-24"> ${renderComponent($$result, "Methodology", $$Methodology, {})} ${renderComponent($$result, "FacultyTeam", $$FacultyTeam, {})} <!-- Unique Insights Section --> <section class="max-w-7xl mx-auto px-4 md:px-14 py-24 border-t border-white/10 relative overflow-hidden"> <div class="absolute inset-0 bg-gradient-to-b from-white/5 to-transparent pointer-events-none"></div> <div class="relative z-10 flex flex-col md:flex-row gap-12 items-center"> <div class="w-full md:w-1/2"> <span class="text-white text-xs font-bold uppercase tracking-widest mb-4 block">First-Party Data</span> <h2 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 break-words">
