...
import { F as FormData, f as formDataToBlob, B as Blob, d as dataUriToBuffer } from "./from_D1w6vMI5.mjs";
import { a } from "./from_D1w6vMI5.mjs";
...
class Body {
  ...
  async formData() {
    ...
    const { toFormData } = await import("./multipart-parser_C4SSZiYe.mjs");
