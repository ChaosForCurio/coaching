import { g as getConfiguredImageService, i as imageConfig, a as inferSourceFormat, f as fetchWithRedirects, s as serverDir, o as outDir } from './_astro_assets_CCV9Pz_r.mjs';
import { readFile } from 'node:fs/promises';
import path from 'node:path';
import { fileURLToPath } from 'node:url';
import { b2 as isRemotePath, b3 as removeQueryString, b4 as isParentDirectory } from './sequence_DI9gLznW.mjs';
import { i as isRemoteAllowed } from './server_CAbLtFaR.mjs';
