...
export { z };
import { ay as generateCspDigest, bh as unescapeHTML, I as renderTemplate, bm as removeBase, b6 as isRemotePath, A as AstroError, bn as UnknownContentCollectionError } from './sequence_Dp-Tbm17.mjs';
import { s as spreadAttributes } from './server_DcQuEEIJ.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Bqcyk2X-.mjs');
