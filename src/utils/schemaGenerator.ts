...
export function generateLocalBusinessSchema() {
  return {
    ...
    description:
      'Government-certified computer training institute in Kota, Rajasthan offering DCA, Tally Prime with GST, Python, Web Development, RSCIT, Digital Marketing, and Graphic Design courses with placement assistance.',
    foundingDate: '2010',
    address: {
      '@type': 'PostalAddress',
