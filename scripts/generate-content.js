...
const testimonials = [
  {
    ...
    text: 'The instructors are amazing! I got placed immediately after the course.',
  },
  {
    name: 'Priya Singh',
    course: 'Tally Prime',
    text: 'Practical learning approach helped me clear my concepts.',
  },
  {
    name: 'Amit Kumar',
    course: 'Python',
    text: 'Highly recommend for beginners. The curriculum is very well designed.',
  },
  {
    name: 'Sneha Gupta',
    course: 'Digital Marketing',
    text: 'I started my own freelance business thanks to their guidance.',
  },
  {
    name: 'Vikas Verma',
    course: 'Graphic Design',
    text: 'Excellent environment and very supportive staff.',
  },
];
fs.writeFileSync(
...
fs.writeFileSync(
  path.join(dataDir, 'placements.json'),
...
const faqs = [
  {
    ...
    answer: 'You can enroll online through our website or visit our campus.',
  },
  {
    question: 'Do you provide placement assistance?',
    answer: 'Yes, we offer 100% placement assistance after course completion.',
  },
  {
    question: 'Are the courses certified?',
    answer: 'Yes, all our courses come with recognized certifications.',
  },
  {
    question: 'Can I take a demo class?',
    answer: 'Yes, we provide 2 days of free demo classes for all courses.',
  },
  {
    question: 'What is the fee structure?',
    answer:
      'The fee varies by course. Please check individual course pages or contact us.',
  },
];
fs.writeFileSync(
...
console.log(
  '✅ Successfully generated 20+ courses, 30+ blogs, city pages, and JSON data files.'
);
